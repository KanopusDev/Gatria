...
This document provides practical examples and tutorials to help you get started with the Eclipse Employee Management System.
...
```python
from eclipse.database.redisdb import RedisDatabase
from eclipse import EmployeeManager
...
```python
from eclipse.models import Employee
...
```python
from eclipse.manager import EmployeeManager
