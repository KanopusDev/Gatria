...
This document provides a comprehensive reference of all classes, methods, and modules available in the Eclipse employee management system.

---

## Core Modules

- [`eclipse.manager`](#eclipsemmanagermodule): Core management classes.
- [`eclipse.models`](#eclipsemmodelsmodule): Data models and schemas.
- [`eclipse.adapters`](#eclipsemadaptersmodule): Framework adapters.
- [`eclipse.database`](#eclipsemdatabasemodule): Database integrations.
- [`eclipse.ml`](#eclipsemmlmodule): Machine Learning components.

---

## `eclipse.manager` Module
...
- **Methods**:
  - `create_app(config: dict = None) -> Flask`
    - Creates and configures a Flask application with Eclipse routes.
...
- **Methods**:
  - `get_urls() -> list`
    - Returns Django URL patterns for the Eclipse app.

### FastAPI Adapter

```python
from eclipse.adapters.fastapi import FastAPIAdapter
...
- **Methods**:
  - `create_app() -> FastAPI`
    - Creates a FastAPI application with Eclipse routes.
...
- `eclipse.utils`: Utility functions and helpers.
- `eclipse.exceptions`: Custom exception classes used within the system.
